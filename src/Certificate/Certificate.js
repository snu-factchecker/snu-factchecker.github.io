            ...
            <div>
                <div ref={ref} id="certificate">
                    ...
                    <div id="cert-wrapper">
                        ...
                        <div className="exp">
                            아래 주제들에 대해 팩트체크 게임을 성공적으로
                            진행하였기에
                            <br />이 인증서를 드립니다.
                        </div>
                        <div id="cert-topics">
                            <div className="topic-wrapper">
                                <div className="topic-name">1. 국가행사</div>
                                <img src={stamp} alt="stamp"></img>
                            </div>
                            <div className="topic-wrapper">
                                <div className="topic-name">2. 사회/교육</div>
                                <img src={stamp} alt="stamp"></img>
                            </div>
                            <div className="topic-wrapper">
                                <div className="topic-name">3. 사회/IT과학</div>
                                <img src={stamp} alt="stamp"></img>
                            </div>
                            {/* <div className="topic-wrapper">
                        ...
                        <img src={stamp} alt="stamp"></img>
                            ...
                            <div className="topic-wrapper">
                                <div className="topic-name">4. 과학/보건</div>
                                <img src={stamp} alt="stamp"></img>
                            </div>
                        </div>

                        <div id="name">
                            <img alt="factcheckcenter logo" src={fclogo}></img>
                        </div>
                    </div>
                </div>
                <div id="inputscreen">
                    <div>
                        인증서 발급을 위해 이름을 입력 후, '인증서 다운로드'를
                        눌러 주세요.
                    </div>
                    <input
                        onChange={(event) =>
                        ...
                        id="nameinput"
                    ></input>
                    <button onClick={this.download}>인증서 다운로드</button>
                </div>
            </div>
        );
    }
