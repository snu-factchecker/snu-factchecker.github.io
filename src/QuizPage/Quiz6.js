	...
	this.setFactScore(20);
		...
		return(<div id="quiz">
			...
			<div id="factmeter">
					...
					<div>총 단서 5개 중 {this.state.cluesCollected.length}개를 찾았습니다.</div>
				</div>
				<div id="notebook">
		...
		<div id="resultcheck">{this.formatGaugeValue(this.state.factScore+50)==="사실"?(<div>정답과 일치합니다. <br/>성공적으로 팩트체크를 진행하셨습니다.</div>):(<div>결과가 일치하지 않습니다.<br/>단서를 더 찾고 싶다면 이전 단계로 돌아가서 찾아보세요.</div>)}</div>
					</div>
					<div>
