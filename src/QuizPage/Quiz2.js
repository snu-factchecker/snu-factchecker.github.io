...
class QuizPage2 extends React.Component {
    ...
    render() {
        ...
        const results_2 = (
            <div id="searchresults">
                <strong onClick={() => this.showAnswers()}>
                    웹사이트 검색 결과
                </strong>
                ...
                <div className="search-result noimage">
                    <div>
                        ...
                        <div className="item-preview">
                            OECD의 가장 최근 국제성인역량조사(PIAAC: Programme
                            ...
                            >
                                한국의 ‘문해력’은 273점으로 OECD평균인 266점보다
                                상당히 높았습니다 (그래프1)
                            </Clue>
                        </div>
                        ...
                        >
                            ...
                            OECD의 가장 최근 국제성인역량조사(PIAAC: Programme
                            for the International Assessment of Adult
                            Competencies)에 따르면 한국의 ‘문해력’은 273점으로
                            OECD평균인 266점보다 상당히 높았습니다 (그래프1).
                            그런데 청년층(16~24세)에서는 OECD 국가 중
                            4위이지만(그래프 2), 25세를 기점으로 급격히 하락해,
                            35∼44세에는 평균 아래, 45세 이후에는 하위권,
                            55∼65세에는 최하위권으로 떨어졌습니다. 연령이
                            높아질수록 문해력 측정 점수가 떨어지는 현상 자체는
                            일반적이었지만 한국의 경우 그 격차가 매우 크다는
                            점이 다른 나라들과 달랐습니다.
                        </div>
                        <div
                ...
                <div className="search-result noimage">
                    <div>
                        ...
                        <div className="item-preview">
                            한국교육개발원 이희수(李熙洙) 연구위원은 지난해 8월
                            16세 이상 65세 미만의 국민 1200여명을 대상으로
                            국제성인문해조사(IALS)를 실시한 결과 문서문해력
                            영역에서 908명(75.7%)이 영수증, 열차시간표,
                            구직원서, 지도, 약 설명서 등의 그림이나 도표를
                            제대로 이해하지 못하는 최하 수준인 1, 2등급으로
                            분류됐다고 2일 밝혔다.
                        </div>
                        <div className="sourceBox">
                        ...
                        >
                            <p>
                                IALS는 단순히 문자를 읽고 쓰는 능력이 아니라
                                일상생활에서 접하는 문자 그림 숫자 정보를
                                이해하고 활용하는 능력을 측정하는 조사로
                                산문문해, 문서문해, 수량문해 등 3가지 영역을
                                측정하며 영역별로 500점 만점으로 계산한다.
                            </p>
                            <p>
                                OECD와 캐나다 통계청이 회원국 등을 대상으로
                                실시한 문해조사에서 한국은 고도의 정보처리
                                능력을 가진 4, 5등급에 해당하는 비율은
                                23개국(스위스는 3개 언어권 별도 실시)의 평균
                                16.2%에 크게 뒤진 2.4%에 그쳐 칠레(1.5%)에 이어
                                최하위를 기록했다. ‘문서문해력’을 500점 만점으로
                                환산한 점수는 237.5점으로 세계 20개국 중 19위를
                                차지했으며 1위는 스웨덴(305.6점)이었다.
                            </p>
                            <p>
                                이 연구위원은 “한글을 단순히 읽고 쓰는 국민은
                                많지만 숫자 문서 도표 등을 정확하게 이해하는
                                문해능력은 떨어진다”면서 “과학적이고 체계적인
                                문해 교육에 국가적인 지원과 관심이 필요하다”고
                                말했다. 박 용기자 parky@donga.com
                            </p>
                        </div>
                        <div
                            className="continue-reading"
                ...
                <div id="quiz">
                    ...
                    {this.state.currentStep === 0 ? (
                        <div className="quizContent">
                            ...
                            <div id="quizitem-content">
                                문해력이라고 들어보셨나요? 우리나라는 세계에서
                                문맹률이 가장 낮은 나라라고 합니다. 글자를 읽지
                                못하는 문맹률은 1% 이하라고 하죠. 누구나 글자는
                                읽는다는 것입니다. 하지만! 글을 이해하는 능력인
                                독해력과 문해력 즉 '실질 문맹률'은 75%에 달해
                                OECD 22개국 중 최하위에 해당된다고 합니다.
							...
							OECD 국가 중 최저"
                                ...
                                <br />
                                <br />
                                문해력은 성인에게는 물론 학생들에게도 중요한
                                능력입니다. 문해력은 아이들의 학습능력과
                                연관되는 만큼 우리 아이의 문해력을 점검해보고
                                문해력을 키울 수 있는 방법을 생각해야 합니다.
                                단편적인 정보 중심, 정제되지 않은 언어로 쓰여진
                                인터넷 글이나 미디어 중심의 정보 습득보다는
                                <Clue
                                    innerText=" 책을 통해 긴 글을 읽고 생각하고 이해하는 교육이 문해력을 키우는
							방법입니다."
                                    tooltip="VERITAS 독서 센터가 독서 토론 교육을 광고하는 것은 아닐까?"
                                    onClick={() =>
                                        this.onClickClue("상업적 의도 의심", 0)
                                    }
                                />
                                <br />
                                <br />
                    ...
                    {this.state.currentStep === 2 ? (
                        <div id="quiz-result">
                            ...
                            {this.state.cluesCollected.length === 5 ? null : (
                                <div>
