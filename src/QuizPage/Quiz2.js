...
<Clue innerText="코로나19 문제가 심각한 홋카이도 지방 그중에서도 감염이 집중된 2개 지역에만 가구당 40장씩 우선 배포하는 이런 계획입니다." tooltip="내용을 읽어보니 특정 지역에 마스크를 공급하는 것인데 
제목은 전국민 지급처럼 해놓았구나." onClick={()=>{
	this.onClickClue("오해의 소지가 있는 제목 선정")
	this.setFactScore(-20)}}></Clue>
</p><p>
...
일본도 내일쯤 일상적인 구매 방법을 담은 조치를 발표할 예정입니다.</p>
		...
		return(<div id="quiz">
			...
			{this.state.currentStep === 2?(<div id="quiz-result">
				...
				<div id="clueCount">총 6개의 단서 중 {clues.length}개의 단서를 찾았습니다.</div>
				<div>
